...
/**
 * Servlet implementation class GetDirectoriesAndDoc
 */
@WebServlet("/GetDirectories")
public class GetDirectories extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//QUERY THE DATABASE TO FIND ALL THE TOP DIRECTORIES OF THE USER
		try {
		...
		String json = new Gson().toJson(directories);
